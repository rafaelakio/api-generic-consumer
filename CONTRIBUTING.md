# Contribuindo para Api Generic Consumer

Obrigado pelo seu interesse em contribuir com o Api Generic Consumer! Este documento guia você através do processo de contribuição.
...
```bash
# Fork o repositório
git clone https://github.com/SEU_USERNAME/api-generic-consumer.git
